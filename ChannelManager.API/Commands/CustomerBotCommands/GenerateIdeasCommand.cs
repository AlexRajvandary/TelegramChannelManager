...
{
    public class GenerateIdeasCommand : ICommand
    {
        ...
        {
            var message = "Введите промт для идей поста:";
            ...
            return new ExecutedCommandParapms(sentMessage, UserState.AwaitingPostIdeasPromt);
        }
    }
}